...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/812474809/BOARD.o: /Users/bijayakhadka/Documents/ECE_13/bkhadka/Lab05/Lab5.X/BOARD.c  .generated_files/flags/default/df41249c67920c9b2d4c821520cea1a0bbd96258 .generated_files/flags/default/b049a9946035c0d6f8c1361b9c30a33141c1b72d
	@${MKDIR} "${OBJECTDIR}/_ext/812474809" 
	@${RM} ${OBJECTDIR}/_ext/812474809/BOARD.o.d 
	@${RM} ${OBJECTDIR}/_ext/812474809/BOARD.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -MP -MMD -MF "${OBJECTDIR}/_ext/812474809/BOARD.o.d" -o ${OBJECTDIR}/_ext/812474809/BOARD.o /Users/bijayakhadka/Documents/ECE_13/bkhadka/Lab05/Lab5.X/BOARD.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/_ext/812474809/Lab05_main.o: /Users/bijayakhadka/Documents/ECE_13/bkhadka/Lab05/Lab5.X/Lab05_main.c  .generated_files/flags/default/ceca9399fb8296e6badc09b5e594369ba3aeeb69 .generated_files/flags/default/b049a9946035c0d6f8c1361b9c30a33141c1b72d
	@${MKDIR} "${OBJECTDIR}/_ext/812474809" 
...
${DISTDIR}/Lab5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  /Users/bijayakhadka/Documents/ECE_13/bkhadka/Lab05/Lab5.X/Lab5SupportLib.a  
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o ${DISTDIR}/Lab5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    /Users/bijayakhadka/Documents/ECE_13/bkhadka/Lab05/Lab5.X/Lab5SupportLib.a      -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=1024,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,${DISTDIR}/memoryfile.xml -mdfp="${DFP_DIR}"
